...
// Celebration background carousel
const celebrationSlides = document.querySelectorAll(".celebration-img");
let celebrationIndex = 0;

setInterval(() => {
  celebrationSlides[celebrationIndex].classList.remove("active");
  celebrationIndex = (celebrationIndex + 1) % celebrationSlides.length;
  celebrationSlides[celebrationIndex].classList.add("active");
}, 4000);
